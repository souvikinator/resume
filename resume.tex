...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{\href{https://github.com/souvikinator/lsx}{lsx (ls-Xtended):  CLI to navigate through terminal with ease }} {[ Go, Shell ]}}{October 2021}
          \resumeItemListStart
         ...
         \resumeProjectHeading
          {\textbf{\href{https://github.com/souvikinator/gh-retrieve}{gh-retrieve: Download specific directory in a public GitHub repository}} {[ NodeJS ]}}{April 2021}
          \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: JavaScript, C++, Go, Bash, Python } \\
